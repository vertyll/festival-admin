...
export default function Sidebar({ show }) {
  const inactiveLink =
    "flex gap-2 p-2 rounded-md hover:bg-indigo-700 transition duration-300";
      ...
      <div>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link
            href={"/artists"}
            className={
              pathname.includes("/artists") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link
            href={"/attributes"}
            className={
              pathname.includes("/attributes") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link
            href={"/news"}
            className={pathname.includes("/news") ? activeLink : inactiveLink}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <Link
            href={"/sponsors"}
            className={
              pathname.includes("/sponsors") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
